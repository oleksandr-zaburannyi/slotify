...
export class RemoveCommandIndex1761326905000 implements MigrationInterface {
    transaction = false;

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`drop index concurrently if exists "rgs_command_processed_roomId_withdrawalStatus_id"`);
    }
